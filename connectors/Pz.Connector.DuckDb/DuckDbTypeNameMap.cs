...
/// <see cref="DuckDbSource.GetSchemaAsync"/>'s contract-is-the-schema answer. Fixed v0 matrix,
/// replicated per the no-cross-connector-reference rule (mirrors Sqlite/MySql's TypeNameMap).</summary>
internal static class DuckDbTypeNameMap
{
