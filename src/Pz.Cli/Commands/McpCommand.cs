...
internal static class McpCommand
{
    ...
    /// calls <see cref="InitCommand.Execute"/> with exactly the arguments `pz init &lt;name&gt;` would
    /// receive if run from <paramref name="dir"/>'s parent directory -- <paramref name="name"/> is
