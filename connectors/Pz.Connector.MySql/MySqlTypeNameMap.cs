...
/// <see cref="MySqlSource.GetSchemaAsync"/>'s contract-is-the-schema answer. Fixed v0 matrix,
/// replicated per the no-cross-connector-reference rule (mirrors LocalFiles' TypeNameMap).</summary>
internal static class MySqlTypeNameMap
{
